...
**Changes in manuscript:** Abstract (page 1, lines 3-24); Figure 1A and 1D (page 4); Results (page 3, lines 82-85 and 117-130; page 5, lines 135-142); Methods, “Fixed record split and signal processing” and “Development-only architecture selection” (page 10, lines 265-285), and “Public cross-domain pretraining and morphology probes” (page 11, lines 302-328); Discussion (page 9, lines 206-213); Supplementary Figures S1 and S3; Supplementary Tables S2, S9, S16 and S18.
