...
PACKAGE_NAME = "Frontiers_R5_JNU_Resubmission_FIG1V2_20260829"
PAYLOAD_NAME = "CTG_R5_JNU_GitHub_Zenodo_FIG1V2_20260829"
...
figure_sources = {
    "Figure_1_R5_JNU_study_design_v2": FIGURES / "Figure_1_R5_JNU_v2_20260829.png",
...
audit_names = [
    ...
    "METHOD_FOUR_GATE_AUDIT_CTG_R5_JNU_FIG1V2.md",
    "method_four_gate_audit_CTG_R5_JNU_FIG1V2.csv",
    "PDF_FINAL_VISUAL_QA_FIG1V2_20260829.md",
...
for source in sorted(FIGURES.glob("Figure_1_R5_JNU_v2_20260829.*")):
    copy(source, PAYLOAD / "figures" / source.name)
...
figure1_v2 = BATCH / "03_analysis" / "figure1_redesign_v2"
for source in sorted((figure1_v2 / "scripts").glob("*.py")):
    copy(source, PAYLOAD / "scripts" / "figure1_v2" / source.name)
for source in sorted((figure1_v2 / "intermediate_tables").glob("*.tsv")):
    copy(source, PAYLOAD / "results" / "figure1_v2" / source.name)
for source in sorted((figure1_v2 / "image2_sources").glob("*.png")):
    copy(source, PAYLOAD / "figures" / "source_assets" / source.name)
for name in [
    "FIGURE_1_V2_QA_REPORT.md",
    "panel_template_candidates.tsv",
    "panel_visual_mapping.md",
    "panel_final_selection.md",
    "figure_layout_spec.tsv",
    "redraw_log.md",
    "persist_source_code_first_validation.md",
    "PERSIST_CANDIDATE_GATE_AUDIT_20260829_v3.md",
]:
    copy(figure1_v2 / name, PAYLOAD / "reproducibility" / "figure1_v2" / name)
